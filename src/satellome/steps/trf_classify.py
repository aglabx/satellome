...
def classify_trf_data(trf_prefix, output_dir, genome_size, keep_trf=False):
    ...
    settings["files"] = {
        ...
        "trf_1kb_file": base_prefix + ".1kb.sat",
        "trf_10kb_file": base_prefix + ".10kb.sat",
        "trf_100kb_file": base_prefix + ".100kb.sat",
        "trf_1000kb_file": base_prefix + ".1000kb.sat",
        "trf_1kb_fasta_file": os.path.join(settings["folders"]["fasta"], base_file + ".1kb.fasta"),
        "trf_10kb_fasta_file": os.path.join(settings["folders"]["fasta"], base_file + ".10kb.fasta"),
        "trf_100kb_fasta_file": os.path.join(settings["folders"]["fasta"], base_file + ".100kb.fasta"),
        "trf_1000kb_fasta_file": os.path.join(settings["folders"]["fasta"], base_file + ".1000kb.fasta"),
        ...
        "gff_1kb_file": os.path.join(settings["folders"]["data_gff3"], base_file + ".1kb.gff"),
        "gff_10kb_file": os.path.join(settings["folders"]["data_gff3"], base_file + ".10kb.gff"),
        "gff_100kb_file": os.path.join(settings["folders"]["data_gff3"], base_file + ".100kb.gff"),
        "gff_1000kb_file": os.path.join(settings["folders"]["data_gff3"], base_file + ".1000kb.gff"),
    }
